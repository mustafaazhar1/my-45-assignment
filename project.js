...
let names = ["ali", "amir", "aliya", "amna", "aftab"];
...
let modesOfTransportation = ["car", "motorcycle", "bicycle", "train"];
...
let placesToVisit = ["Kyoto", "Santorini", "Machu Picchu", "Banff National Park", "Galápagos Islands"];
...
let programmingLanguages = ["JavaScript", "Python", "TypeScript", "Java", "C++"];
// Printing the array
...
let usernames = ["admin", "john", "alice", "bob", "smith"];
...
let usernames2 = ["admin", "john", "alice", "bob", "smith"];
...
let current_users = ["admin", "john", "alice", "bob", "smith"];
let new_users = ["alice", "john", "dave", "emily", "chris"];
...
function make_grea1t(magicians) {
